...
namespace MauiValidationDemo
{
	...
	{
        public static bool IsFormValid(object model, ContentPage page)
        {
        ...
        private static void HideValidationFields(object model, ContentPage page, string validationLabelSuffix = "Error")
        {
        ...
        private static void ShowValidationFields(List<ValidationResult> errors, object model, ContentPage page, string validationLabelSuffix = "Error")
        {
            if (model == null) { return; }
